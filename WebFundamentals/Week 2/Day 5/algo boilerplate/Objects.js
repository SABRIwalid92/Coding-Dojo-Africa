...
for(var i = 0; i < pokemon.length; i++){
    if(pokemon[i].types[1]) console.log(pokemon[i]);
}
// 3. console.log the names of the pokémon whose only type is "poison"
for(var i = 0; i < pokemon.length; i++){
    if(pokemon[i].types === 0 && pokemon[i].types[0] == "poison") console.log(pokemon[i]);
}
...
for(var i = 0; i < pokemon.length; i++){
    if((pokemon[i].types.length === 0) && (pokemon[i].types[0] == "poison")) {
        
        pokemon[i].name = reversed(pokemon[i].name);
